...
SemesterSystem.prototype.fillInSemster = function (givenSemesterArrayPosition) {
    this.semesters[givenSemesterArrayPosition].associatedCell.html("<div> " + this.semesters[givenSemesterArrayPosition].name + " </div>");
    this.semesters[givenSemesterArrayPosition].computeCHGPA();
    this.semesters[givenSemesterArrayPosition].associatedCell.html(this.semesters[givenSemesterArrayPosition].associatedCell.html() + this.semesters[givenSemesterArrayPosition].fillInSemster());
    this.semesters[givenSemesterArrayPosition].associatedCell.html(this.semesters[givenSemesterArrayPosition].associatedCell.html() + "<div> Credit Hours : " + this.semesters[givenSemesterArrayPosition].CreditHours + " </div>");
    this.semesters[givenSemesterArrayPosition].associatedCell.html(this.semesters[givenSemesterArrayPosition].associatedCell.html() + "<div> GPA : " + this.semesters[givenSemesterArrayPosition].GPA + "  </div>");
};
